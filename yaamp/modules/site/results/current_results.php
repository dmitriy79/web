...
foreach($algos as $item)
{
	...
	if($defaultalgo == $algo)
		echo "<tr style='cursor: pointer; background-color: #4caf50;' onclick='javascript:select_algo(\"$algo\")'>";
	else
...
if($defaultalgo == 'all')
	echo "<tr style='cursor: pointer; background-color: #4caf50;' onclick='javascript:select_algo(\"all\")'>";
else
